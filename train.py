...
Updated to include PSPNet support.
"""
...
def parse_args():
    ...
    parser.add_argument('--encoder', type=str, default='resnet50', 
                        help='Encoder backbone (for DeepLab and PSPNet)')
    ...
    # PSPNet specific arguments
    parser.add_argument('--pspnet_aux_loss', action='store_true', default=True,
                        help='Use auxiliary loss in PSPNet for deep supervision (default: True)')
    parser.add_argument('--pspnet_lesion_specific', action='store_true',
                        help='Use lesion-specific PSPNet variant')
...
def train_one_epoch(model, dataloader, loss_fn, optimizer, device, epoch, writer, metric_tracker):
    ...
    for batch_idx, batch in enumerate(progress_bar):
        ...
        if model_name in ['DeepLabV3Plus', 'AttentionUNet', 'UNet', 'PSPNet', 'PSPNetLesionSegmentor']:
            # Models with potential deep supervision

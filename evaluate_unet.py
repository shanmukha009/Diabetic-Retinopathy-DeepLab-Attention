...
Now supports UNet, DeepLab, and Attention U-Net architectures.
"""
...
def parse_args():
    ...
    parser.add_argument('--encoder', type=str, default='resnet50', 
                        help='Encoder backbone (resnet34, resnet50) - for DeepLab only')
...
def load_model_from_checkpoint(args, device):
    ...
    # Check if checkpoint contains training parameters for UNet
    if args.model == 'unet' and isinstance(checkpoint, dict) and 'train_params' in checkpoint:
        train_params = checkpoint['train_params']
        print("Found training parameters in checkpoint:")
        
        # Verify UNet parameters match
        param_mismatches = []
